                ...
                success: function(response) {
                    ...
                    if (atendimentos.length > 0) {
                        ...
                        for (var i = 0; i < atendimentos.length; i++) {
                            ...
                            var title = atendimento.servico + ' (' + atendimento.espera + ')' + atendimento.cliente.nome ;
                            
                            var item = '<li><a style="color:'+atendimento.corPrioridade+'" href="javascript:void(0)" onclick="' + onclick + '" title="' + title + '">' + atendimento.senha + '- '+ atendimento.nomePrioridade+'</a></li>';
                            list.append(item);
                        }
