            ...
            SGA.ajax({
                ...
                success: function(response) {
                    if (btn.prop('checked')) {
                        ...
                        $('#max-senhas-' + btn.data('id')).prop('disabled',false);
                        $('#hora-limite-' + btn.data('id')).prop('disabled',false);
                    } else {
                        $('.servico-' + btn.data('id')).prop('disabled', true);
                        $('#max-senhas-' + btn.data('id')).prop('disabled',true);
                        $('#hora-limite-' + btn.data('id')).prop('disabled',true);
                    }
                },
                error: function() {
        ...
        change: function(id) {
            ...
            SGA.ajax({
                ...
                data: {
                    ...
                    sigla: $('#sigla-' + id).val(),
                    local: $('#local-' + id).val(),
                    maxsenhas: $('#max-senhas-' + id).val(),
                    horalimite: $('#hora-limite-' + id).val(),
                    peso: peso
                }
            });
        }
